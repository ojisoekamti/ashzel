    ...
    <body class="bg-gray-50">
        ...
        @else
            <div class="flex flex-col items-center justify-center w-screen h-screen">
                ...
                <div
                    class="flex flex-col items-center w-full max-w-lg p-10 mx-auto mt-8 bg-white border border-gray-100 shadow-xl rounded-xl">
                    <h1 class="text-3xl font-semibold text-blue-600">Welcome to Aszhel</h1>
                    <p class="mt-5 text-gray-500">If you're ready to get started, click on the 'Install Wave' button
                        below. In this future this installation screen will have a few setup options.</p>
